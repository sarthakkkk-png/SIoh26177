...
| Coding Acceleration | Cursor, Freebuff | AI-assisted coding | Productivity for solo work |
...
- speed_mps (float)
- battery_pct (float)
- status (enum: IDLE, FLYING, RTH, LANDED, ERROR)
- timestamp (ISO 8601)
...
**Tech Stack**  
Python, FastAPI, Ultralytics YOLO, Supabase, React + Leaflet, Groq, Vercel, Google Colab, Stitch, GitHub, Cursor/Freebuff, Canva.
